...
public class prelokadalat {
    ...
    { 
        String CRNO,CRMAT;
        int first_index = content.indexOf("PRE LOK ADALAT");
        for(int i=0;i<100;i++)
            {    
            int second_index = content.indexOf("PRE LOK ADALAT", (first_index+5));
            ...
            {
                CRMAT = content.substring(first_index+15);
                CRNO = content.substring(first_index,first_index+15);
            ...
            {
                CRMAT = content.substring(first_index+15,second_index);
                CRNO = content.substring(first_index,first_index+15);
                crmat(CRNO,CRMAT,i,k,start,end);
            }
