...
public class lokadalat {
    ...
    { 
        String CRNO,CRMAT;
        int first_index = content.indexOf("LOK ADALAT PETITIONS");
        for(int i=0;i<100;i++)
            {    
            int second_index = content.indexOf("LOK ADALAT PETITIONS", (first_index+5));
            ...
            {
                CRMAT = content.substring(first_index+11);
                CRNO = content.substring(first_index,first_index+11);
            ...
            {
                CRMAT = content.substring(first_index+11,second_index);
                CRNO = content.substring(first_index,first_index+11);
                crmat(CRNO,CRMAT,i,k,start,end);
            }
